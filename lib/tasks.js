...
const { cwd, assets, temp, output, debug, remote, branch } = config
 ...
 * Clean output task
 */
gulp.task('clean', del.bind(null, [temp, output]))
 ...
 * Compile task
 */
gulp.task('compile', cb => runSequence('clean', ['styles', 'scripts', 'pages'], cb))
